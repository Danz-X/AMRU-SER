...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Raditya' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+6281252009563' : process.env.NUMBER,   
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '6281252009563@s.whatsapp.net' : process.env.TAG_REPLY,
